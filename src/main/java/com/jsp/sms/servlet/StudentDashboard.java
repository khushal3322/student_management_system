...
public class StudentDashboard extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Student student = (Student) req.getAttribute("featch");
...
//			printWriter.print("</body></html>");
			...
			printWriter.print(" a {\r\n"
					...
					+ "            </tbody>\r\n"
					+ "        </table>\r\n<br><br>");
				printWriter.print("<br>\n<a href=\"UpdateByStudent.html\">Update</a>"
					+ "    </section>");
				printWriter.print("<a href=\"Student.html\">LogOut</a>"
						+ "    </section>");
			printWriter.print("</body></html>");
			
		} else { 
			
			RequestDispatcher requestDispatcher = req.getRequestDispatcher("StudentDashboard");
			requestDispatcher.include(req, resp);
			printWriter.print("<html><body>");
			printWriter.print("<h3>Id :<h3>"+ student+"<h3>not available<h3>");
			printWriter.print("</body></html>"); 
		}
